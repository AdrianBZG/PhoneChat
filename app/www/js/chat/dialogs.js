...
function getDialogIcon (dialogType) {
  var groupPhoto = '<img src="img/chat/ava-group.svg" width="30" height="30" class="round">';
  var privatPhoto  = '<img src="img/chat/ava-single.svg" width="30" height="30" class="round">';
