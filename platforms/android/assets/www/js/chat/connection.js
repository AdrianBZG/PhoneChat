...
var osScreen;
var osBrowser;
var osBrowserVersion;
var osBrowserMajorVersion;
var osMobile;
var osName;
var osVersionName;
var osCookies;
...
function updateAccountInfoPage() {
  ...
  $("#userNameField").text("You're logged in as: " + storedName);
...
function updateDeviceIpInfo() {
  $.ajax({
        ...
        success: function(location) {
            //alert(location.ip);
            $("#userIpAddressField").text("Your connection IP address is: " + location.ip);
        }
    });
}

function updateSystemInfoText() {
   $("#userOSname").text("Operating system: " + osName);
   if(osVersionName != "-") {
     $("#userOSversion").text("Operating system version: " + osVersionName);
   } else {
     $("#userOSversion").text("Operating system version: UNKNOWN");
   }
}
...
$(document).ready(
  function() {
    ...
    $('#btnAccountLogout').on('click', function() {
...
// Getting all the system and browser info
function getSystemInfo() {
    ...
    osScreen = screenSize;
    osBrowser = browser;
    osBrowserVersion = version;
    osBrowserMajorVersion = majorVersion;
    osMobile = mobile;
    osName = os;
    osVersionName = osVersion;
    osCookies = cookieEnabled;
    osFlashVersion = flashVersion;
}
