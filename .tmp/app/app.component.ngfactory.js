...
var _View_MyApp_Host0 = (function (_super) {
    ...
    _View_MyApp_Host0.prototype.createInternal = function (rootSelector) {
        this._el_0 = this.selectOrCreateHostElement('main', rootSelector, null);
...
export var MyAppNgFactory = new import11.ComponentFactory('main', viewFactory_MyApp_Host0, import0.MyApp);
var styles_MyApp = [];
