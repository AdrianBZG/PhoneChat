...
class _View_Chat_Host0 extends import1.AppView<any> {
  ...
  createInternal(rootSelector:string):import3.AppElement {
    this._el_0 = this.selectOrCreateHostElement('chat',rootSelector,(null as any));
...
function viewFactory_Chat_Host0(viewUtils:import4.ViewUtils,parentInjector:import5.Injector,declarationEl:import3.AppElement):import1.AppView<any> {
  if ((renderType_Chat_Host === (null as any))) { (renderType_Chat_Host = viewUtils.createRenderComponentType('',0,import10.ViewEncapsulation.None,([] as any[]),{})); }
  return new _View_Chat_Host0(viewUtils,parentInjector,declarationEl);
}
export const ChatNgFactory:import11.ComponentFactory<import0.Chat> = new import11.ComponentFactory<import0.Chat>('chat',viewFactory_Chat_Host0,import0.Chat);
...
class _View_Chat0 extends import1.AppView<import0.Chat> {
  ...
  _text_17:any;
  _el_18:any;
  _Header_18_3:import14.Wrapper_Header;
  _text_19:any;
  _el_20:any;
  /*private*/ _appEl_20:import3.AppElement;
  _Navbar_20_4:import18.Wrapper_Navbar;
  _text_21:any;
  _el_22:any;
  /*private*/ _appEl_22:import3.AppElement;
  _ToolbarTitle_22_4:import15.Wrapper_ToolbarTitle;
  _text_23:any;
  _text_24:any;
  _text_25:any;
  _text_26:any;
  ...
  _Content_27_4:import16.Wrapper_Content;
  _text_28:any;
  _text_29:any;
  /*private*/ _expr_0:any;
  /*private*/ _expr_1:any;
  ...
  createInternal(rootSelector:string):import3.AppElement {
    ...
    this._Header_2_3 = new import14.Wrapper_Header(this.parentInjector.get(import21.Config),new import20.ElementRef(this._el_2),this.renderer,this.parentInjector.get(import26.ViewController,(null as any)));
    ...
    this._Toolbar_4_4 = new import14.Wrapper_Toolbar(this.parentInjector.get(import26.ViewController,(null as any)),this.parentInjector.get(import21.Config),new import20.ElementRef(this._el_4),this.renderer);
    ...
    this._ToolbarTitle_6_4 = new import15.Wrapper_ToolbarTitle(this.parentInjector.get(import21.Config),new import20.ElementRef(this._el_6),this.renderer,this._Toolbar_4_4.context,this.parentInjector.get(import27.Navbar,(null as any)));
    ...
    this._el_18 = this.renderer.createElement(parentRenderNode,'ion-header',(null as any));
    this._Header_18_3 = new import14.Wrapper_Header(this.parentInjector.get(import21.Config),new import20.ElementRef(this._el_18),this.renderer,this.parentInjector.get(import26.ViewController,(null as any)));
    this._text_19 = this.renderer.createText(this._el_18,'\n  ',(null as any));
    this._el_20 = this.renderer.createElement(this._el_18,'ion-navbar',(null as any));
    this.renderer.setElementAttribute(this._el_20,'class','toolbar');
    this._appEl_20 = new import3.AppElement(20,18,this,this._el_20);
    var compView_20:any = import18.viewFactory_Navbar0(this.viewUtils,this.injector(20),this._appEl_20);
    this._Navbar_20_4 = new import18.Wrapper_Navbar(this.parentInjector.get(import28.App),this.parentInjector.get(import26.ViewController,(null as any)),this.parentInjector.get(import8.NavController,(null as any)),this.parentInjector.get(import21.Config),new import20.ElementRef(this._el_20),this.renderer);
    this._appEl_20.initComponent(this._Navbar_20_4.context,([] as any[]),compView_20);
    this._text_21 = this.renderer.createText((null as any),'\n    ',(null as any));
    this._el_22 = this.renderer.createElement((null as any),'ion-title',(null as any));
    this._appEl_22 = new import3.AppElement(22,20,this,this._el_22);
    var compView_22:any = import15.viewFactory_ToolbarTitle0(this.viewUtils,this.injector(22),this._appEl_22);
    this._ToolbarTitle_22_4 = new import15.Wrapper_ToolbarTitle(this.parentInjector.get(import21.Config),new import20.ElementRef(this._el_22),this.renderer,this.parentInjector.get(import30.Toolbar,(null as any)),this._Navbar_20_4.context);
    this._appEl_22.initComponent(this._ToolbarTitle_22_4.context,([] as any[]),compView_22);
    this._text_23 = this.renderer.createText((null as any),'User',(null as any));
    compView_22.create(this._ToolbarTitle_22_4.context,[([] as any[]).concat([this._text_23])],(null as any));
    ...
    var compView_27:any = import16.viewFactory_Content0(this.viewUtils,this.injector(27),this._appEl_27);
    ...
    this._appEl_27.initComponent(this._Content_27_4.context,([] as any[]),compView_27);
    this._text_28 = this.renderer.createText((null as any),'\n\n',(null as any));
    compView_27.create(this._Content_27_4.context,[
      ([] as any[]),
      ([] as any[]).concat([this._text_28]),
      ([] as any[])
    ]
    ,(null as any));
  ...
  injectorGetInternal(token:any,requestNodeIndex:number,notFoundResult:any):any {
    if (((token === import31.ToolbarTitle) && ((6 <= requestNodeIndex) && (requestNodeIndex <= 7)))) { return this._ToolbarTitle_6_4.context; }
    ...
    if (((token === import32.List) && ((13 <= requestNodeIndex) && (requestNodeIndex <= 14)))) { return this._List_13_3.context; }
    if (((token === import33.Content) && ((11 <= requestNodeIndex) && (requestNodeIndex <= 15)))) { return this._Content_11_4.context; }
    if (((token === import34.Menu) && ((0 <= requestNodeIndex) && (requestNodeIndex <= 16)))) { return this._Menu_0_4.context; }
    if (((token === import31.ToolbarTitle) && ((22 <= requestNodeIndex) && (requestNodeIndex <= 23)))) { return this._ToolbarTitle_22_4.context; }
    if (((token === import27.Navbar) && ((20 <= requestNodeIndex) && (requestNodeIndex <= 24)))) { return this._Navbar_20_4.context; }
    if (((token === import30.Header) && ((18 <= requestNodeIndex) && (requestNodeIndex <= 25)))) { return this._Header_18_3.context; }
    if (((token === import33.Content) && ((27 <= requestNodeIndex) && (requestNodeIndex <= 28)))) { return this._Content_27_4.context; }
    return notFoundResult;
  }
  detectChangesInternal(throwOnChange:boolean):void {
    ...
    if (this._ToolbarTitle_22_4.detectChangesInternal(this,this._el_22,throwOnChange)) { this._appEl_22.componentView.markAsCheckOnce(); }
    if (this._Content_27_4.detectChangesInternal(this,this._el_27,throwOnChange)) { this._appEl_27.componentView.markAsCheckOnce(); }
    this.detectContentChildrenChanges(throwOnChange);
    const currVal_0:any = this._Toolbar_4_4.context._sbPadding;
    if (import4.checkBinding(throwOnChange,this._expr_0,currVal_0)) {
      this.renderer.setElementClass(this._el_4,'statusbar-padding',currVal_0);
      this._expr_0 = currVal_0;
    }
    const currVal_1:any = import4.interpolate(1,'',this.context.user,'');
    ...
    const currVal_3:any = this._Navbar_20_4.context._hidden;
    if (import4.checkBinding(throwOnChange,this._expr_3,currVal_3)) {
      this.renderer.setElementProperty(this._el_20,'hidden',currVal_3);
      this._expr_3 = currVal_3;
    }
    const currVal_4:any = this._Navbar_20_4.context._sbPadding;
    if (import4.checkBinding(throwOnChange,this._expr_4,currVal_4)) {
      this.renderer.setElementClass(this._el_20,'statusbar-padding',currVal_4);
      this._expr_4 = currVal_4;
    }
    const currVal_5:any = this._Content_27_4.context._sbPadding;
    if (import4.checkBinding(throwOnChange,this._expr_5,currVal_5)) {
      this.renderer.setElementClass(this._el_27,'statusbar-padding',currVal_5);
      this._expr_5 = currVal_5;
    }
    this.detectViewChildrenChanges(throwOnChange);
    if (!throwOnChange) { if ((this.numberOfChecks === 0)) { this._Navbar_20_4.context.ngAfterViewInit(); } }
  }
...
export function viewFactory_Chat0(viewUtils:import4.ViewUtils,parentInjector:import5.Injector,declarationEl:import3.AppElement):import1.AppView<import0.Chat> {
  if ((renderType_Chat === (null as any))) { (renderType_Chat = viewUtils.createRenderComponentType('',0,import10.ViewEncapsulation.None,styles_Chat,{})); }
